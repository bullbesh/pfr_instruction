...
main_node = KeyboardNode(
    title="/start",
    text=(
        "Добрый день, коллеги! Чат-бот постарается ответить на самые "
        "популярные вопросы наших будущих пенсионеров, "
        "связанных с процедурой выхода на пенсию. "
        "Нажмите на интересующую Вас тему.\n\nВнимание! Чат-бот предлалает "
        "готовые вопросы и ответы. Не надо писать ему своих сообщений, "
        "просто выбирайте предлагаемые кнопки."
    ),
    buttons=[
        pension_period,
